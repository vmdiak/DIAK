...
public class Boa extends Predator {
    ...
    private double weight = Config.BOA.WeightNormal;
    private int maxAmount = Config.BOA.AmountMax;
    ...
    public int eat(Vector<Animal> vector) {
        for (Animal val:
            ...
            if (!(val instanceof Bear)) {
                if (val.isAlive()) {
                    ...
                    if (weight < (Config.BOA.WeightNormal + Config.BOA.SatiatedMax)) {
        ...
        alive = weight >= Config.BOA.WeightNormal / 10.0;
